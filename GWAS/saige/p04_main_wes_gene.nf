...
include {get_chrom_bfiles; get_chrom_vcf_files; saige_gene_step1_chrom_gt; saige_gene_step2_vcf} from './utils_saige'
...
workflow {    
    ...
    saige_gene_step1_chrom_gt(chrom_bfiles, params.pheno_cova_fn, params.spsGRM, params.spsSample, params.covariates, params.cate_cova, params.trait_type, ava_cpu)
    ...
    saige_gene_step1_chrom_gt.out.step1_out
        .join(chrom_vcf_files, by:0)
        .set {input4step2}
    


    saige_gene_step2_vcf(input4step2, params.spsGRM, params.spsSample, params.gene_group_fn, params.vcf_field)
